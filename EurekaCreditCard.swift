//
// Created by Demetrio Filocamo on 18/03/2016.
// Copyright (c) 2016 Made In Italy App Ltd. All rights reserved.
//
...
public protocol CreditCardCell {
...
public class DefaultCreditCardCell<T:CreditCardType>: Cell<T>, CellType, UITextFieldDelegate, CreditCardCell, UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    public override func update() {
        ...
        expirationMonthTextField.maxLength = 2
        ...
        expirationYearTextField.maxLength = 4
...
public class _CreditCardRow<T:Equatable, Cell:CellType where Cell: BaseCell, Cell: CreditCardCell, Cell.Value == T>: Row<T, Cell>, CreditCardRowConformance, KeyboardReturnHandler {
...
public final class CreditCardRow: _CreditCardRow<CreditCard, DefaultCreditCardCell<CreditCard>>, RowType {
